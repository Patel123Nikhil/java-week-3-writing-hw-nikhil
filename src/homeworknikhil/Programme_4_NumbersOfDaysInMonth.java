 ...
 * Otherwise, if it is in valid range, calculate if the year is a leap year and return if it is,
 * Otherwise return false.
 * A year is a leap year if it is divisible by 4 but not by 100, or it is divisable 400.
...
public class Programme_4_NumbersOfDaysInMonth {
    public static void main(String[] args) {
        ...
        // 5 outputs to get days in month
